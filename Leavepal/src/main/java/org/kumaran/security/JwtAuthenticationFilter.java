...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        request.setAttribute("auth.failure", "none");
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")
            ...
            if (jwtUtil.validateToken(token)) {
                ...
                if (userExists) {
                    ...
                    request.setAttribute("auth.role", normalizedRole);
                } else {
                    request.setAttribute("auth.failure", "user_not_found");
                }
            } else {
                request.setAttribute("auth.failure", jwtUtil.getValidationFailureReason(token));
            }
        }
