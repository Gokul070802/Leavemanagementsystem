...
public interface LeaveApplicationRepository extends JpaRepository<LeaveApplication, Long> {
        List<LeaveApplication> findByEmployeeIdOrUsernameOrEmailIdOrderByCreatedAtDesc(String employeeId,
                        String username,
                        String emailId);
        ...
        @Query("""
                        ...
                        order by la.createdAt asc
                        """)
        List<LeaveApplication> findByIdentityAndStatusesOrderByCreatedAtAsc(@Param("employeeId") String employeeId,
                        @Param("username") String username,
                        @Param("emailId") String emailId,
                        @Param("statuses") Collection<String> statuses);
